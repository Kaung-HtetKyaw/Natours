...
var stripe = Stripe("pk_test_51HkZ6uII8M1Dpz7AHron79TY9DmvShtz20zYBIjFTyNEh5mZMri5BvnVDtioYmy4gcOy88NlrztIXmN3fzSbAPkH004sN6kCxv");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            ...
            _context.t0 = _context["catch"](0);
            console.log(_context.t0);
            (0, _alert.showAlert)("error", "Error Booking Tour");
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1Ijoia2F1bmdodGV0a3lhdyIsImEiOiJja2gwbTRhb3gwbmg1MzNybnVvYnNoMjI0In0.z84zN_ixcjNUDAi9-VslRg";
...
if (bookBtn) {
  bookBtn.addEventListener("click", /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(e) {
      var originalTextContent, tourId;
      return regeneratorRuntime.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "44849" + '/');
